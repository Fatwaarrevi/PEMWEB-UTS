...
@section('content')
    ...
    <form action="{{ route('beasiswa.update', $beasiswa->nomor_pendaftaran) }}" method="POST" class="mt-5">
        @method('put')
        @csrf
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}"
                    name="nama" value="{{ old('nama') ?: $beasiswa->nama }}">
                @if ($errors->has('nama'))
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('nomor_pendaftaran') ? 'is-invalid' : '' }}" name="nomor_pendaftaran"
                    value="{{ $beasiswa->nomor_pendaftaran }}" readonly>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" name="email"
                    value="{{ old('email') ?: $beasiswa->email }}">
                @if ($errors->has('email'))
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('program_studi') ? 'is-invalid' : '' }}" name="program_studi"
                    value="{{ old('program_studi') ?: $beasiswa->program_studi }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('jenis_beasiswa') ? 'is-invalid' : '' }}" name="jenis_beasiswa"
                    value="{{ old('jenis_beasiswa') ?: $beasiswa->jenis_beasiswa }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('gelombang_penerimaan') ? 'is-invalid' : '' }}" name="gelombang_penerimaan"
                    value="{{ old('gelombang_penerimaan') ?: $beasiswa->gelombang_penerimaan }}">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control {{ $errors->has('status_beasiswa') ? 'is-invalid' : '' }}" name="status_beasiswa"
                    value="{{ old('status_beasiswa') ?: $beasiswa->status_beasiswa }}">
